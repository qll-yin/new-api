...
func InitOptionMap() {
	...
	common.OptionMap["VideoModelConfig"] = ratio_setting.VideoModelConfig2JSONString()
...
func updateOptionMap(key string, value string) (err error) {
	...
	case "VideoModelConfig":
		err = ratio_setting.UpdateVideoModelConfigByJSONString(value)
	case "CacheRatio":
