...
type TaskPrivateData struct {
	RequestID         string `json:"request_id,omitempty"`          // 本系统的请求 request ID
	UpstreamRequestID string `json:"upstream_request_id,omitempty"` // 上游父 request ID
...
type TaskBillingContext struct {
	...
	ResolvedModelPrice float64         `json:"resolved_model_price,omitempty"` // 请求解析后的有效单价（如视频分辨率价）
