...
const createModelSchema = (t: Translate) =>
  z.object({
    ...
    VideoModelConfig: createJsonStringField(t),
...
export function RatioSettingsCard({
  ...
  const modelNormalizedDefaults = useRef({
    ...
    VideoModelConfig: normalizeJsonString(modelDefaults.VideoModelConfig),
  ...
  const modelForm = useForm<ModelFormValues>({
    ...
    defaultValues: {
      ...
      VideoModelConfig: formatJsonForTextarea(modelDefaults.VideoModelConfig),
  ...
  const saveModelRatios = useCallback(
    async (values: ModelFormValues) => {
      const normalized = {
        ...
        VideoModelConfig: normalizeJsonString(values.VideoModelConfig),
    ...
    return (
      <UpstreamRatioSync
        modelRatios={{
          ...
          VideoModelConfig: modelDefaults.VideoModelConfig,
