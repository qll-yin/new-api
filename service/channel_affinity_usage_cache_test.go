...
func nextChannelAffinityStatsTestID(prefix string) string {
	return fmt.Sprintf("%s_%d", prefix, channelAffinityStatsTestSeq.Add(1))
}
...
func TestObserveChannelAffinityUsageCacheByRelayFormat_ClaudeMode(t *testing.T) {
	ruleName := nextChannelAffinityStatsTestID("rule_claude")
	usingGroup := "default"
	keyFP := nextChannelAffinityStatsTestID("fp_claude")
...
func TestObserveChannelAffinityUsageCacheByRelayFormat_MixedMode(t *testing.T) {
	ruleName := nextChannelAffinityStatsTestID("rule_mixed")
	usingGroup := "default"
	keyFP := nextChannelAffinityStatsTestID("fp_mixed")
	ctx := buildChannelAffinityStatsContextForTest(ruleName, usingGroup, keyFP)
...
func TestObserveChannelAffinityUsageCacheByRelayFormat_UnsupportedModeKeepsEmpty(t *testing.T) {
	ruleName := nextChannelAffinityStatsTestID("rule_unsupported")
	usingGroup := "default"
	keyFP := nextChannelAffinityStatsTestID("fp_unsupported")
	ctx := buildChannelAffinityStatsContextForTest(ruleName, usingGroup, keyFP)
